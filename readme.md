...
- **streamlit** - используется, как инструмент для визуализации

![](images/stack.png)
Современное аналитическое решение. У нас нет боковых элементов, есть streamlit для **графиков**, и также заменены:
- **dagster** -> **airflow**
- **dbt** -> **airflow**
...
docker compose up -d
```
[Подробнее про выбор инструментов.](infra.md)
...
Каждый день  по расписанию запускается процесс очистки файлов из **ducklake**.

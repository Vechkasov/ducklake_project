...
> В посте [DuckDB benchmarked against Spark](https://blog.dataexpert.io/p/duckdb-can-be-100x-faster-than-spark) сравнили **Spark** и **DuckDB** на локальном MacBook Pro, и утка показала отличный результат.
